...
<div class="collapse collapse-horizontal show" id="collapseExample">
    <div class="d-flex flex-column flex-shrink-0 p-3 d-none d-md-flex" style="height: 100vh; width: 16rem; background-color: #fafafa;">
        
        <div class="offcanvas-header gap-1 p-3">
        ...
        <ul class="list-group nav nav-pills flex-column mb-auto gap-1">
            ...
            <li>
                <router-link to="/dashboard/export" class="d-flex gap-2 align-items-center list-group-item list-group-item-action rounded-2" style="border: 0px;">
                    ...
                    <span style="font-size: 0.875rem; font-weight: 500;">Import/export</span>
                </router-link>
            </li>
            ...
            <li>
                ...
                <div class="collapse show" id="home-collapse"> 
                    <ul class="list-unstyled fw-normal" style="font-size: 0.875rem;"> 
                        <li class="py-2">
                            <router-link class="ms-5 bg-white text-decoration-none" style="color: #8a8a8a;">
                                Account
                            </router-link>
                        </li> 
                        <li>
