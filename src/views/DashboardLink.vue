    ...
    <div class="container overflow-scroll overflow-scroll-md my-2" style="overflow-x: hidden!important;">
        ...
        <div class="d-flex flex-column flex-sm-row sticky-top bg-white pt-3 pb-3 " style="min-height: 4.45rem; border-bottom: 0px solid lightgrey;">
            <div class="d-flex flex-grow-1 align-items-center justify-content-start" >
                ...
                <div class="d-flex">
                    <span style="font-size: 0.875rem; color: #6a6a6a;">{{ this.$route.name }} / {{ this.$route.params.id }}</span>
                </div>
            ...
            <div class="col-12" >
                <div class="rounded-3 p-4 w-100 shadow-sm" style="border: 1px solid lightgray;">
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-3">
                        ...
                        <div class="d-flex align-items-center gap-0 gap-md-3">
        ...
        <!-- summary stats -->
        <div class="row g-3 m-0 pb-3"> 
            <h3 class="pt-3">Summary statistics</h3>
            <div class="col-12 col-md-4">
                <div class="card rounded-3 p-2">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-1">  
                            <p class="mb-0" style="font-size: 0.875rem;">Visitors</p>                         
                        ...
                        <div class="mb-3">
                            <h2 class="fw-bold mb-0">2743</h2>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <p class="fw-bold badge bg-success-subtle text-success mb-0">↑50%</p> 
                            <p class="fw-bold mb-0" style="font-size: 0.8rem; color: #8a8a8a;">last month</p>                              
                        </div>
            ...
            <div class="col-12 col-md-4">
                <div class="card rounded-3 p-2">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-1">  
                            <p class="mb-0" style="font-size: 0.875rem;">Clicks</p>                         
                        ...
                        <div class="mb-3">
                            <h2 class="fw-bold mb-0">328</h2>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <p class="fw-bold badge bg-danger-subtle text-danger mb-0">↑23%</p> 
                            <p class="fw-bold mb-0" style="font-size: 0.8rem; color: #8a8a8a;">last month</p>                              
                        </div>
            ...
            <div class="col-12 col-md-4">
                <div class="card rounded-3 p-2">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-1">  
                            <p class="mb-0" style="font-size: 0.875rem;">Referrers</p>                         
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <p class="fw-bold badge bg-success-subtle text-success mb-0">↑11%</p> 
                            <p class="fw-bold mb-0" style="font-size: 0.8rem; color: #8a8a8a;">last month</p>                              
                        </div>                        
        ...
        <div class="row g-3 m-0 pb-3">
            <div class="col-12 col-md-6 d-flex mb-3 mb-md-0">
                <div class="card rounded-3 table-responsive p-4 w-100">
